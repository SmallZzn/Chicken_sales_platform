  ...
  <div class="goods_detail">
    <div class="product">
      ...
      <div class="product-info">
        ...
        <el-input v-model="review.comment" placeholder="请输入你的评价"></el-input>
        <button class="add-to-cart" @click="addReview(product.productId,review.orderId)">提交评价</button>
      </div>
    </div>
...
export default {
  ...
  created() {
    this.orderdetailId = this.$route.params.orderdetailId;
    this.review.orderId = this.$route.params.orderId;
